...
class ProdutoListagemCustoAoVivoIT {
    ...
    void listagemRecalculaCustoUnitarioSemResalvarProduto() {
        ...
        Page<ProdutoResponse> paginaAntes = produtoService.listar(null, null, null, null, PageRequest.of(0, 10));
        ...
        Page<ProdutoResponse> paginaDepois = produtoService.listar(null, null, null, null, PageRequest.of(0, 10));
